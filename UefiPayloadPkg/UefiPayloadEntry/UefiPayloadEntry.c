  ...
  )
{
  ...
  PLD_SMBIOS_TABLE_HOB             *SmBiosTableHob;
  ...
  //
  SmBiosTableHob = BuildGuidHob (&gPldSmbiosTableGuid, sizeof (PLD_SMBIOS_TABLE_HOB));
  ...
  //
  AcpiTableHob = BuildGuidHob (&gPldAcpiTableGuid, sizeof (PLD_ACPI_TABLE_HOB));
